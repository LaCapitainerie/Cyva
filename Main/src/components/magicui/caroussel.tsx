...
interface CarouselSlidesDataType {
    title: string;
    subtitle: string;
    description: string;
    image: string;
...
interface FinalEmblaCarouselProps {
    slides: CarouselSlidesDataType[];
};


export function Emblacarousel({ slides }: FinalEmblaCarouselProps) {
  const OPTIONS: EmblaOptionsType = { loop: true };
  const SLIDES = slides.map((testimonial, idx) => (
    <div
      key={idx}
